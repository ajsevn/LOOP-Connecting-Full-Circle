...
?>
<html>
    <title>Loop - Social Networking Site</title>
    <head>
    <!-- <meta charset="UTF-8"> -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="Experience social networking like never before with Loop, 
     ...
     a collection of shared moments. Explore the diverse world of Loop by visiting other users' 
     account pages. Forge personal connections through private messaging, 
     making Loop the ultimate destination for authentic social networking.">
    ...
    <div class="login-signup">
        <center><img class="login-logo" src="logo/logo2.png" alt="logo"></center>
